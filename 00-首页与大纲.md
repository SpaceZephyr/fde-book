...
中文名《FDE 手册》。把 AI 装进企业：从需求识别到生产交付

**创建者**：空格
**为谁创建**：想转型 FDE 的工程师和产品经理、正在组建 FDE 团队的 AI 公司、需要把 AI 落进业务的企业负责人
**基于**：Palantir / OpenAI / AWS / Anthropic 的公开实践，以及 2026 年一线企业 AI 交付的复盘
**最后更新**：2026-08-31
**适用场景**：需求诊断、方案设计、Context 与 Harness 建设、上线交付、团队搭建
...
| §02 | 顺序：FDE 工作里唯一不能变的东西 | 知道四个依赖段谁先谁后，以及跳过谁会死在哪 |
...
- A 企业 AI 需求诊断表
- B Outcome Contract 模板
- C Context Registry 模板
- D 生产上线检查清单
- E 五层指标体系
- F 偏差分类速查
- G 六个问题：判断真 FDE
